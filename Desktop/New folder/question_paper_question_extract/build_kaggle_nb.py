...
# ---------------------------------------------------------------------------
# Cell 6: Question Segmentation + Per-Question Extraction
# ---------------------------------------------------------------------------
cells.append({
    "cell_type": "code",
    "source": [
...
# ---------------------------------------------------------------------------
# Cell 7: Load images from Kaggle input -> Segment -> Analyze -> Collect JSON
# ---------------------------------------------------------------------------
cells.append({
    "cell_type": "code",
    "source": [
...
output_path = r"C:\Users\USER\Desktop\private_IITRPR\IITRPR_INTERN\question_paper_question_extract\gemma26b-image-metrics-illustrator.ipynb"
with open(output_path, 'w', encoding='utf-8') as f:
    # Minify to single line for Kaggle compatibility (reduces file size)
